...
# Note: in the paper, we use the adaptive EI-index, defined by the `polarisation6` function.
# Notation: 
#   - p_in_a : frac of edges inside community alpha.
#   - p_in: aggregate frac of in-edges. 
...
### RANDOM ENSEMBLES FUNCTIONS (TODO)
